...
define('ERR_NON_SECURE_PASSWORD', 'The database password provided contains a single quote!  For security reasons this character is not valid.  You have two options: <br/>1. Remove the single quote character from your password.<br/>2. Open the installer.php and set the variable $GLOBALS[DUPX_DBPASS_CHECK] = false');
