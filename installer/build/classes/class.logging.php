...
define('ERR_ZIPEXTRACTION',		'Errors extracting zip file.  Portions or part of the zip archive did not extract correctly.   You may have to use manual extraction mode under advanced options. Try to extract the archive manually to make sure the file is not corrupted.');
