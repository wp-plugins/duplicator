...
<div id="content">
	...
	if ($action == 'process') {
		...
		dinstaller_log("secure build name: 503961eb87a4c1590_package");
		dinstaller_log("----------------------------------");
