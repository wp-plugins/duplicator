...
<div id="content">
	...
	if ($action == 'process') {
		...
		dinstaller_log("secure build name: 5044b7cd9f4a77594_nichesite_4");
		dinstaller_log("----------------------------------");
