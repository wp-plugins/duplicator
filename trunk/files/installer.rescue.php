...
<div id="content">
	...
	if ($action == 'process') {
		...
		dinstaller_log("secure build name: 503f654c6a4f12760_20120830_duplicatorplugin");
		dinstaller_log("----------------------------------");
