...
<head>
	...
	<link rel="stylesheet" id="duplicator_style-css" href="<?php echo $plugins_url; ?>/duplicator/assets/css/style.css" type="text/css" media="all">
	<style type="text/css">
		body {font-family: "Open Sans",sans-serif; font-size: 13px;	line-height: 1.4em;}
		iframe#log-data {box-shadow: 4px 4px 3px #999; border:1px solid silver; border-radius:5px; width:98%; height:85%; }
	...
	<script type="text/javascript" src="<?php echo $admin_url; ?>load-scripts.php?c=0&amp;load=jquery-core"></script>
		...
		<tr>
			<td style='white-space:nowrap'>
				...
				<i style='font-size:12px'>
					<?php _e("Processing may take several minutes, please wait for progress bar to complete.", 'wpduplicator') ?><br/>
